...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question","name": "What is BroncoCTF 2026?","acceptedAnswer": {"@type": "Answer","text": "BroncoCTF is a jeopardy-style Capture-The-Flag competition run by Cal Poly Pomona's Cyber Security Club (the 'Broncos'). The 2026 edition ran beginner, crypto, forensics, misc, pwn, reverse, and web categories, with challenges from 10 points up to a few hundred points. Flag format bronco{...}. This writeup covers three beginner challenges (Digital Crumbs, No Laughing Matter, Pwntorial), one forensics challenge (Bundle 99), and two misc challenges (Spot The Difference, Zip Zip Hooray). Paired pwn + reverse and web + crypto writeups on the same site. Per-challenge READMEs and solvers at github.com/Abdelkad3r/BroncoCTF-2026."}},
